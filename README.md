...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-kdl/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-kdl/actions/workflows/validate.yml)

Neovim tree-sitter queries for **kdl**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-kdl",
...
- [ ] Changes are scoped to `kdl` — do not include files for other languages
